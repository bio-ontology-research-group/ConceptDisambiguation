...
print "Chemical vector length:"+str(len(chemicalVector))
print "Disease vector length:"+str(len(diseaseVector))
print "Genes vector length:"+str(len(genesVector))

corpusRepresentation = [chemicalVector,diseaseVector,genesVector]
